...
<style type="text/css">
	...
	.map{width: 98%; height: 430px; background: blue; margin-top: 2px; margin-left: 1%; ; float: left;}
...
<%@ include file="./form/header.jsp" %>
	...
	<div class="gg">
	 <div class="medical_name">
		...
		<div>
			<button id="appointment" value="진료예약" style="z-index:1; position: relative;" onclick="goInsertTelForm();">
