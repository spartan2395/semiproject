...
<style type="text/css">
	...
	div.frboardList table tbody tr td:first-child{text-align: left;}
	div.frboardList table tbody tr {border-top: 1px solid #f4f2ef; height: 60px;}
	.frboardWrap table button{border: 1px solid #c6b5a4; padding: 9px 15px 9px 15px; color: #c6b5a4; position: relative; left: 850px;}
