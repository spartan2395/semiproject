    ...
    <div class="container">
        ...
        <input type="hidden" name="command" value="update">
            <div id="idpw">
                ...
                <div>
                    <h4>비밀번호</h4>
                    <span><input type="text" placeholder="8자리 이상 16자리 이하 숫자와 알파벳" class ="chk" id="pw" title="notready" required></span>
                    <p class="required"></p>
                </div>
                <div>
                    <h4>비밀번호 확인</h4>
                    <span><input type="text" class ="chk" id="pwchk"  title="notready" name="pw" required></span>
                    <p class="required"></p>
                </div>
            </div>
...
<!--                         <p class="required"></p> -->
    ...
    <div id="footer">
        <p>@Carrot Doctor Team <br> jfekjfkejkfjekfk|fefefeeffef | fwfwefefefefe | fefegegegege |
            fewgaegegege<br><br><br></p>
    </div>
